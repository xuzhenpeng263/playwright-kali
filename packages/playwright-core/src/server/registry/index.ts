...
const DOWNLOAD_PATHS: Record<BrowserName | InternalTool, DownloadPaths> = {
  'chromium': {
    ...
    'kali-x64': 'builds/chromium/%s/chromium-linux.zip',
    'kali-arm64': 'builds/chromium/%s/chromium-linux-arm64.zip',
  ...
  'chromium-headless-shell': {
    ...
    'kali-x64': 'builds/chromium/%s/chromium-headless-shell-linux.zip',
    'kali-arm64': 'builds/chromium/%s/chromium-headless-shell-linux-arm64.zip',
    'mac10.13': undefined,
    'mac10.14': undefined,
    'mac10.15': undefined,
  ...
  'chromium-tip-of-tree': {
    ...
    'kali-x64': 'builds/chromium-tip-of-tree/%s/chromium-tip-of-tree-linux.zip',
    'kali-arm64': 'builds/chromium-tip-of-tree/%s/chromium-tip-of-tree-linux-arm64.zip',
  ...
  'chromium-tip-of-tree-headless-shell': {
    ...
    'kali-x64': 'builds/chromium-tip-of-tree/%s/chromium-tip-of-tree-headless-shell-linux.zip',
    'kali-arm64': 'builds/chromium-tip-of-tree/%s/chromium-tip-of-tree-headless-shell-linux-arm64.zip',
    'mac10.13': undefined,
    'mac10.14': undefined,
    'mac10.15': undefined,
  ...
  'firefox': {
    ...
    'kali-x64': 'builds/firefox/%s/firefox-debian-12.zip',
    'kali-arm64': 'builds/firefox/%s/firefox-debian-12-arm64.zip',
  ...
  'firefox-beta': {
    ...
    'kali-x64': 'builds/firefox-beta/%s/firefox-beta-debian-12.zip',
    'kali-arm64': 'builds/firefox-beta/%s/firefox-beta-debian-12-arm64.zip',
  ...
  'webkit': {
    ...
    'kali-x64': 'builds/webkit/%s/webkit-debian-12.zip',
    'kali-arm64': 'builds/webkit/%s/webkit-debian-12-arm64.zip',
    'mac10.13': undefined,
  ...
  'ffmpeg': {
    ...
    'kali-x64': 'builds/ffmpeg/%s/ffmpeg-linux.zip',
    'kali-arm64': 'builds/ffmpeg/%s/ffmpeg-linux-arm64.zip',
  ...
  'android': {
    ...
    'kali-x64': 'builds/android/%s/android.zip',
    'kali-arm64': 'builds/android/%s/android.zip',
