...
export const deps: any = {
  ...
  // Kali Linux configuration - Kali is a rolling distribution based on Debian testing
  'kali-x64': {
    tools: [
      'xvfb',
      'fonts-noto-color-emoji',
...
deps['kali-arm64'] = {
  tools: [...deps['kali-x64'].tools],
  chromium: [...deps['kali-x64'].chromium],
  firefox: [
    ...deps['kali-x64'].firefox,
  ],
  webkit: [
    ...deps['kali-x64'].webkit,
  ],
  lib2package: {
    ...deps['kali-x64'].lib2package,
  },
};
